...
// in simulator we redefine to format for databankSurveyor Developer console
...
{\
	NSString * exceptionName = [@"org.databanksurveyor." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.databanksurveyor";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIdatabankSurveyorNativeItemNone = -1, 
	UIdatabankSurveyorNativeItemSpinner = -2,
	UIdatabankSurveyorNativeItemProgressBar = -3,
	
	UIdatabankSurveyorNativeItemSlider = -4,
	UIdatabankSurveyorNativeItemSwitch = -5,
	UIdatabankSurveyorNativeItemMultiButton = -6,
	UIdatabankSurveyorNativeItemSegmented = -7,
	
	UIdatabankSurveyorNativeItemTextView = -8,
	UIdatabankSurveyorNativeItemTextField = -9,
	UIdatabankSurveyorNativeItemSearchBar = -10,
	
	UIdatabankSurveyorNativeItemPicker = -11,
	UIdatabankSurveyorNativeItemDatePicker = -12,
	
	UIdatabankSurveyorNativeItemInfoLight = -13,
	UIdatabankSurveyorNativeItemInfoDark = -14,
	
	UIdatabankSurveyorNativeItemDisclosure = -15,
	
	UIdatabankSurveyorNativeItemContactAdd = -16
};
